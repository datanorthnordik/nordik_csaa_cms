...
import type { DrawerNavItem } from '../components/CmsDrawer'
...
export function DashboardPage() {
  ...
  const navItems: DrawerNavItem[] = [
    ...
    { key: 'newsletters', label: 'Newsletters', icon: icons.newsletters },
    { key: 'press', label: 'Press Entries', icon: icons.press },
    { key: 'memorial', label: 'Memorial Entries', icon: icons.memorial },
